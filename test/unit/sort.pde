...
_checkEqual(sort(s1), rs1);
_checkEqual(sort(s2_3,3), rs2_3);
_checkEqual(sort(s3), rs3);
_checkEqual(sort(s4), rs4);
_checkEqual(sort(s5), rs5);
_checkEqual(sort(s6), rs6);
_checkEqual(sort(s7), rs7);
_checkEqual(sort(s8_4,4), rs8_4);
_checkEqual(sort(s9[1]), rs9);
_checkEqual(sort(s10), rs10);
_checkEqual(sort(s11), rs11);
_checkEqual(sort(s12), rs12);
_checkEqual(sort(s13), rs13);
_checkEqual(sort(s14), rs14);
_checkEqual(sort(s15), rs15);
_checkEqual(sort(s16), rs16);

_checkEqual(sort(i1), ri1);
_checkEqual(sort(i2_3), ri2_3);
_checkEqual(sort(i3), ri3);
_checkEqual(sort(i4), ri4);
_checkEqual(sort(i5_4,4), ri5_4);
_checkEqual(sort(i6), ri6);
_checkEqual(sort(i7), ri7);
_checkEqual(sort(i8_3), ri8_3);
_checkEqual(sort(i9), ri9);
_checkEqual(sort(i10), ri10);
_checkEqual(sort(i11_8,8), ri11_8);
_checkEqual(sort(i12[0]), ri12);
_checkEqual(sort(i13_5[3],5), ri13_5);

// FLOATS
_checkEqual(sort(f1), rf1);
_checkEqual(sort(f2), rf2);
_checkEqual(sort(f3), rf3);
_checkEqual(sort(f4), rf4);
_checkEqual(sort(f5_4, 4), rf5_4);
_checkEqual(sort(f6_1, 1), rf6_1);
_checkEqual(sort(f7_5, 5), rf7_5);
_checkEqual(sort(f8), rf8);
_checkEqual(sort(f9_3), rf9_3);
_checkEqual(sort(f10), rf10);
_checkEqual(sort(f11), rf11);
_checkEqual(sort(f12), rf12);
_checkEqual(sort(f13_9,9), rf13_9); 
