/*
    ...
    L A Z Y   L O A D I N G   F O R   P R O C E S S I N G . J S - @VERSION@
...
(function() {
	 ...
	 */
	if(!isDOMPresent) { throw("This browser does not support the w3c DOM interface, which this lazy loading for Processing.js relies on."); }

	/**
	 * If there is no Processing.js, don't run.
	 */
	if(!Processing) { throw("Please load Processing.js before loading the \"lazy loading\" extension."); }
